...
Klassen, Spezialisierungen und Rollen nutzen unveränderte Spiel-Icons von [Blizzards offiziellen Klassenseiten](https://worldofwarcraft.blizzard.com/en-us/game/classes) und dem `render.worldofwarcraft.com`-CDN. Die vier klassischen Horde-Rassen zeigen unveränderte Charakterbilder von [Blizzards offizieller Rassenseite](https://worldofwarcraft.blizzard.com/en-us/game/races). Der aktive Hintergrund `wow-forever-background.png` wurde vom Betreiber bereitgestellt und enthält bereits das WoW-Forever-Logo. Die bisherige Titelillustration `forever-hero-art.png` bleibt als lokale Alternative erhalten; sie trägt eine Horley-Signatur. Diese Bilder und World of Warcraft sind © Blizzard Entertainment. Die [Blizzard Legal FAQ](https://www.blizzard.com/en-us/legal/10390250-087d-41fd-aa47-1a44cbacb10b/legal-faq) beschreibt eine widerrufliche, beschränkte Nutzung von Blizzard-Inhalten für private, nicht-kommerzielle Fan-Webseiten. Für eine kommerzielle oder anderweitige Veröffentlichung ist eine eigene Rechteprüfung nötig.
